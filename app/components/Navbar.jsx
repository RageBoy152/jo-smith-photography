  ...
  return (
    <div className="absolute z-[150] w-full">
      <nav className="font-imperial-script text-white text-2-lg w-10/12 flex flex-col lg:flex-row items-start lg:items-center justify-between py-5 mx-auto">
        ...
        <div className={`transition-opacity ${!navbarActive ? 'pointer-events-none opacity-0' : ''} lg:pointer-events-auto lg:opacity-100 h-dvh lg:h-auto nav-bg-gradient lg:bg-none absolute lg:relative top-full start-0 px-5 lg:px-0 py-10 lg:py-0 w-full lg:w-auto flex flex-col lg:flex-row justify-center items-center lg:items-start gap-8`}>
