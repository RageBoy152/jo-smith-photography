export async function fetchImagesFromUnsplash(tag, count) {
    if (process.env.NODE_ENV == "production") {
        console.log(`[PRODUCTION] Fetching images from unsplash: Tag: ${tag} | Count: ${count}`);
        ...
        console.log(`[${process.env.NODE_ENV}] Skipping unsplash API call, returning default data`);
